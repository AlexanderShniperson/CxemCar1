...
public class MainActivity extends Activity implements OnClickListener {
    ...
    Button btnActAccelerometer, btnActWheel, btnActButtons, btnActMCU, btnActTouch, btnActAbout, btnActPreferences;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnActPreferences = (Button) findViewById(R.id.button_preferences);
        btnActPreferences.setOnClickListener(this);
    }
