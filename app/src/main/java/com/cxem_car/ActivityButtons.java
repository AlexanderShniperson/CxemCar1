...
public class ActivityButtons extends Activity {
	...
	private String commandHorn;		// command symbol for optional command (for example - horn) from settings (ñèìâîë êîìàíäû äëÿ äîï. êàíàëà (çâóêîâîé ñèãíàë) èç íàñòðîåê)
